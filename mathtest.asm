...
wait_for_P3_7:
	jb P3.7, $ ; loop while the button is not pressed
	Wait_Milli_Seconds(#50) ; debounce time
	jb P3.7, wait_for_P3_7 ; it was a bounce, try again
	jnb P3.7, $ ; loop while the button is pressed
	ret
...
Forever:
	...
	; Now wait for BOOT to be pressed and released so we can see the result.
	lcall wait_for_P3_7
	...
	Load_x(5635678)
	Load_y(1234)
	lcall div32 ; This subroutine is in math32.inc
	lcall hex2bcd
	lcall Display_10_digit_BCD
	lcall wait_for_P3_7
	...
	Load_x(1234)
	Load_y(4567)
	lcall add32 ; This subroutine is in math32.inc
	lcall hex2bcd
	lcall Display_10_digit_BCD
	lcall wait_for_P3_7
