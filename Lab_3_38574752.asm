...
response_loop_%M:
	jb RECALC, frequency_response_%M ; loop while the button is not pressed
	Wait_Milli_Seconds(#50) ; debounce time
	jb RECALC, frequency_response_%M ; it was a bounce, try again
	jnb RECALC, $ ; loop while the button is pressed
    ljmp %0
